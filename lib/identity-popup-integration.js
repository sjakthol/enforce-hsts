...
const IdentityPopupIntegration = {
  ...
  _attachIdentityPopup: function (window) {
    ...
    popup.addEventListener("popupshowing", this.refreshIdentityPopup.bind(this));
    ...
    checkbox.addEventListener("command", this.toggleEnforcing.bind(this));
    doc.getElementById("identity-popup-content-box").appendChild(checkbox);
  },
